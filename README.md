...
- `app.py`: تشغيل المشروع عبر CLI بدون Gradio.
...
4. راجع ملفات التتبع داخل مجلد `logs/`.

## ملاحظات

- النوتبوك يحتوي نظام Logs مستقل لكل خلية.
- عند إعادة تشغيل أي خلية، يتم حذف ملف الـLog القديم الخاص بها تلقائيًا.
